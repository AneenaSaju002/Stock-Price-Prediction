...
filepath = "stock_weights1.keras"  # or use 'stock_weights1.h5' if you prefer HDF5 format

from keras.callbacks import ReduceLROnPlateau, ModelCheckpoint

# ReduceLROnPlateau: Reduces the learning rate when the validation loss plateaus, to reduce overfitting
